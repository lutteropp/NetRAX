...
WANTED_TIMEOUTS = [0, 60] # Timeout of zero means a singl enetrax random starting network, timeout larger than zero means continue starting from other random networks until timeout has been reached
...
if __name__ == "__main__":
    run_experiments(WANTED_NUM_TAXA, WANTED_NUM_RETICULATIONS, WANTED_MSA_SIZES, WANTED_M_VALUES, WANTED_SIMULATORS, WANTED_SAMPLINGS, WANTED_TIMEOUTS)
