...
bool isActiveBranch(AnnotatedNetwork &ann_network,
...
std::vector<Node *> getActiveAliveNeighbors(Network &network,
                                            const std::vector<bool> &dead_nodes,
                                            const Node *node);
bool hasNeighbor(const Node *node1, const Node *node2);
std::unordered_set<size_t> getNeighborPmatrixIndices(Network &network,
                                                     const Edge *edge);
std::vector<Node *> getNeighborsWithinRadius(Network &network, const Node *node,
