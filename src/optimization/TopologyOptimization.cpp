...
double greedyHillClimbingTopology(AnnotatedNetwork &ann_network, MoveType type, NetworkState& start_state_to_reuse, NetworkState& best_state_to_reuse, bool greedy, bool randomize_candidates, bool brlenopt_inside, bool enforce_apply_move, bool silent, size_t max_iterations) {
    ...
    do {
        ...
        case MoveType::RNNIMove:
            new_score = hillClimbingStep(ann_network, possibleRNNIMoves(ann_network), start_state_to_reuse, best_state_to_reuse, old_bic, greedy, randomize_candidates, brlenopt_inside, silent);
            break;
        case MoveType::RSPRMove:
            new_score = hillClimbingStep(ann_network, possibleRSPRMoves(ann_network), start_state_to_reuse, best_state_to_reuse, old_bic, greedy, randomize_candidates, brlenopt_inside, silent);
            break;
        case MoveType::RSPR1Move:
            new_score = hillClimbingStep(ann_network, possibleRSPR1Moves(ann_network), start_state_to_reuse, best_state_to_reuse, old_bic, greedy, randomize_candidates, brlenopt_inside, silent);
            break;
        case MoveType::HeadMove:
            new_score = hillClimbingStep(ann_network, possibleHeadMoves(ann_network), start_state_to_reuse, best_state_to_reuse, old_bic, greedy, randomize_candidates, brlenopt_inside, silent);
            break;
        case MoveType::TailMove:
            new_score = hillClimbingStep(ann_network, possibleTailMoves(ann_network), start_state_to_reuse, best_state_to_reuse, old_bic, greedy, randomize_candidates, brlenopt_inside, silent);
            break;
        case MoveType::ArcInsertionMove:
            new_score = hillClimbingStep(ann_network, possibleArcInsertionMoves(ann_network), start_state_to_reuse, best_state_to_reuse, 
                    old_bic, greedy, randomize_candidates, brlenopt_inside, silent);
            break;
...
double greedyHillClimbingTopology(AnnotatedNetwork &ann_network, const std::vector<MoveType>& types, NetworkState& start_state_to_reuse, NetworkState& best_state_to_reuse, bool greedy, bool randomize_candidates, bool brlenopt_inside, bool silent, size_t max_iterations) {
    ...
    do {
        ...
        new_logl = greedyHillClimbingTopology(ann_network, types[type_idx], start_state_to_reuse, best_state_to_reuse, greedy, randomize_candidates, brlenopt_inside, silent, 1);
...
void optimizeTopology(AnnotatedNetwork &ann_network, const std::vector<MoveType>& types, NetworkState& start_state_to_reuse, NetworkState& best_state_to_reuse, bool greedy, bool silent, size_t max_iterations) {
    ...
    greedyHillClimbingTopology(ann_network, types, start_state_to_reuse, best_state_to_reuse, greedy, false, true, silent, max_iterations);
...
void optimizeTopology(AnnotatedNetwork &ann_network, MoveType& type, NetworkState& start_state_to_reuse, NetworkState& best_state_to_reuse, bool greedy, bool enforce_apply_move, bool silent, size_t max_iterations) {
    assert(logl_same_after_recompute(ann_network));
    double old_score = scoreNetwork(ann_network);
    greedyHillClimbingTopology(ann_network, type, start_state_to_reuse, best_state_to_reuse, greedy, false, true, enforce_apply_move, silent, max_iterations);
    double new_score = scoreNetwork(ann_network);
