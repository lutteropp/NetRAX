...
void optimizeBranches(AnnotatedNetwork &ann_network,
                      double brlen_smooth_factor = 100, bool silent = true,
                      bool restricted_total_iters = false);
...
enum class OptimizeAllNonTopologyType { QUICK = 0, NORMAL = 1, SLOW = 2 };

void optimizeAllNonTopology(AnnotatedNetwork &ann_network,
                            OptimizeAllNonTopologyType type,
                            bool silent = true);
