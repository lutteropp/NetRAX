...
void updateMoveClvIndexArcInsertion(Move& move, size_t old_clv_index, size_t new_clv_index, bool undo = false);
void updateMovePmatrixIndexArcInsertion(Move& move, size_t old_pmatrix_index, size_t new_pmatrix_index, bool undo = false);
