...
NodeDisplayedTreeData& NodeDisplayedTreeData::operator =(NodeDisplayedTreeData&& rhs)
{
    if (this != &rhs)
    {
...
NodeDisplayedTreeData& NodeDisplayedTreeData::operator =(const NodeDisplayedTreeData& rhs)
{
    if (this != &rhs)
    {
