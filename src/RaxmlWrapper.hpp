...
TreeInfo createRaxmlTreeinfo(RaxmlInstance &instance, Network &network); // Creates a network treeinfo
TreeInfo createRaxmlTreeinfo(RaxmlInstance &instance, const pll_utree_t *utree); // Creates a tree treeinfo
