...
double computeLoglikelihoodBrlenOpt(AnnotatedNetwork &ann_network, const std::vector<TreeLoglData>& oldTrees, unsigned int pmatrix_index, int incremental = 1, int update_pmatrices = 1);
