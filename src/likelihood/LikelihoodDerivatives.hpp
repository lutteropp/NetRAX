...
struct SumtableInfo {
  ...
  SumtableInfo(size_t sumtable_size, size_t alignment,
               DisplayedTreeData *left_tree, DisplayedTreeData *right_tree,
               size_t left_tree_idx, size_t right_tree_idx)
      : sumtable_size{sumtable_size},
        alignment{alignment},
        left_tree{left_tree},
        right_tree{right_tree},
        left_tree_idx{left_tree_idx},
        right_tree_idx{right_tree_idx} {}

  ~SumtableInfo() { pll_aligned_free(sumtable); }

  SumtableInfo(SumtableInfo &&rhs)
