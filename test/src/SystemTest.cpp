...
TEST (SystemTest, problem20) {
    problemTest("((((((((C:0.025,((((A:0.025)#3:0.0125::0.5)#5:0.0125::0.5)#2:0.5::0.5)#4:0.5::0.5):0.0125,#3:1::0.5):0.00625,#4:1::0.5):0.00625)#0:0.025::0.5)#1:0.025::0.5,(D:0.05,#5:1::0.5):0.05):0.05,#1:1::0.5):0.05,(B:0.05,#0:1::0.5):0.05,#2:0.05::0.5);");
}
