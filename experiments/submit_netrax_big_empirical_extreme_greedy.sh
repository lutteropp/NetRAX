...
mpiexec $netrax --msa $ali --model $model --seed 42 --output $outdir/merged_genes_inferred_network_greedy.nw --best_displayed_tree_variant --brlen linked --start_network $raxtree --extreme_greedy --good_start
