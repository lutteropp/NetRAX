...
python3 ${netrax_script} --name "snakes_multi_best" --msa_path $ali --partitions_path $model --likelihood_type best --brlen_linkage_type linked --seed 42 --start_networks $badtrees_unique
python3 ${netrax_script} --name "snakes_multi_average" --msa_path $ali --partitions_path $model --likelihood_type average --brlen_linkage_type linked --seed 42 --start_networks $badtrees_unique
