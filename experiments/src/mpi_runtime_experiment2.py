...
MPI_PROCS = [128,112,96,80,64,48,32,16]

def parse_command_line_arguments_mpi_exp2():
    CLI = argparse.ArgumentParser()
    CLI.add_argument("--prefix", type=str, default="mpi_runtime2")
...
def simulate_stuff(prefix, n_taxa, n_reticulations):
    (_, settings) = exp_runtime2(n_taxa, n_reticulations)
...
if __name__ == '__main__':
    prefix, n_taxa, n_reticulations, iteration = parse_command_line_arguments_mpi_exp2()
